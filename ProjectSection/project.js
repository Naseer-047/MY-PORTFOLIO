...
let data = [
...

  {
    ...
    projdesc:
      "AI-powered resume analyzer that evaluates ATS score, skills, and gives improvement suggestions.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "Python",
  ...
  },
  {
    ...
    projdesc:
      "Live collaborative code editor with multi-user cursor sync like Google Docs.",
    langsused1: "React",
  ...
  },
  {
    ...
    projdesc:
      "Complete SaaS application with authentication, subscription plans, and payment integration.",
    langsused1: "React",
    langsused2: "Node.js",
  ...
  },
  {
    ...
    projdesc:
      "Smart AI chatbot for customer support, FAQs, and productivity use cases.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "AI API",
  ...
  },
  {
    ...
    projdesc:
      "Platform to submit code, execute it securely, and evaluate against test cases.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "Docker",
  ...
  },
  {
    ...
    projdesc:
      "Live stock market simulator with real-time prices and virtual trading system.",
    langsused1: "React",
    langsused2: "WebSockets",
    langsused3: "API",
  ...
  },
  {
    ...
    projdesc:
      "Tracks expenses and displays insights using charts and monthly analytics.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "Chart.js",
  ...
  },
  {
    ...
    projdesc:
      "Cloud-based file upload, storage, sharing, and access control system.",
    langsused1: "React",
    langsused2: "Firebase",
  ...
  },
  {
    ...
    projdesc:
      "Online learning platform with courses, quizzes, certificates, and dashboards.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "MongoDB",
  ...
  },
  {
    ...
    projdesc:
      "Generate images from text prompts using artificial intelligence models.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "AI API",
  ...
  },
  {
    ...
    projdesc:
      "Online multiplayer game with real-time player synchronization and chat.",
  ...
  },
  {
    ...
    projdesc:
      "Job portal where recruiters post jobs, users apply, and admin manages platform.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "MongoDB",
  ...
  },
  {
    ...
    projdesc:
      "Advanced e-commerce app with AI recommendations, payments, and order tracking.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "Stripe API",
  ...
  },
  {
    ...
    projdesc:
      "Jira-like project management system with tasks, boards, and analytics.",
    langsused1: "React",
    langsused2: "Node.js",
    langsused3: "MongoDB",
  ...
  },
  {
    ...
    projdesc:
      "AI-powered mock interview platform with feedback and performance analysis.",
    langsused1: "React",
    langsused2: "Python",
    langsused3: "AI API",
  ...
  },
  {
    ...
    projdesc:
      "Dashboard to monitor system threats, logs, and security analytics.",
    langsused1: "React",
    langsused2: "Node.js",
  ...
  },
  {
    ...
    projdesc:
      "Drag-and-drop website builder with live preview and export options.",
    langsused1: "React",
    langsused2: "JavaScript",
  ...
  },
  {
    ...
    projdesc:
      "Monitors server performance, logs, uptime, CPU and memory usage.",
    langsused1: "React",
    langsused2: "Node.js",
...

  {
    ...
    projdesc:
      "Responsive calculator supporting basic arithmetic operations with clean UI.",
    langsused1: "HTML",
    langsused2: "CSS",
    langsused3: "JavaScript",
  ...
  },
  {
    ...
    projdesc:
      "Interactive quiz app with multiple questions, score tracking, and timer functionality.",
    langsused1: "HTML",
    langsused2: "CSS",
    langsused3: "JavaScript",
  ...
  },
  {
    ...
    projdesc:
      "Fetches real-time weather data using API based on city or location.",
    langsused1: "HTML",
    langsused2: "CSS",
    langsused3: "JavaScript",
  ...
  clutter += `
     <div class="project-card hamburger-card overflow-hidden zoom-in will-change" data-animate>
                    ...
                    <div class="p-6 md:p-8">
                        ...
                        <a href="#" class="text-primary font-medium hover:underline inline-flex justify-end items-centerr  w-full stagger-btn">
                         <div class="flex items-center justify-center text-center rounded-3xl p-4 border-black border border-2 logu ">   view more  
                          
                           <i class="fas  logu fa-arrow-right ml-2"></i> </div>
                        </a>
                    </div>
                </div>
